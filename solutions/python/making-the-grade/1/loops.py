...
def round_scores(student_scores):
    ...
    rounde_score_lst = [round(student_score) for student_score in student_scores]
    return rounde_score_lst
...
def count_failed_students(student_scores):
    ...
    """
    failed = [student for student in student_scores if student <= 40]
    return len(failed)
...
def above_threshold(student_scores, threshold):
    ...
    best_students = [student_score for student_score in student_scores if student_score >= threshold]
...
def student_ranking(student_scores, student_names):
    ...
    for index, student_score in enumerate(student_scores):
        final_list.append(f"{index+1}. {student_names[index]}: {student_score}")
