...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
     ...
     # 1. Convert spread percentage to a decimal and add it to the exchange rate
    actual_rate = exchange_rate * (1 + (spread / 100))
    
    # 2. Calculate the unrounded amount of foreign currency you can buy
    total_foreign_currency = budget / actual_rate
    
    # 3. Find how many full bills of that denomination fit into the total
    number_of_bills = total_foreign_currency // denomination
    
    # 4. Multiply back to get the final total exchangeable value as an integer
