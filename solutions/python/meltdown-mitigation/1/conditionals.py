...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    if percentage >= 80:
        ...
        return "Error in the calculation check function again!"
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    current_product_value = temperature * neutrons_produced_per_second
    current_percentage_threshold = (current_product_value / threshold) * 100

    if current_percentage_threshold < 90:
        return "LOW"
    elif current_percentage_threshold >= 90 and current_percentage_threshold <= 110:
        return "NORMAL"
    elif current_percentage_threshold > 110:
        return "DANGER"
    else:
        return "Error in calculating the percentage threshold value..."
